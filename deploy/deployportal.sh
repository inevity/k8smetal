...
. $SCRIPT_PDIR/docker-deploy.sh
. $SCRIPT_PDIR/kube-deploy.sh
. $SCRIPT_PDIR/ddns-deploy.sh
...
function usage()
{
    ...
    echo "    -m modules      : one or more modules in docker or  kube separated by comma"
    echo "                      such as 'docker or 'docker,kube'"
